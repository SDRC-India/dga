package org.sdrc.dgacg.collect.android.receivers;
...
import org.sdrc.dgacg.collect.android.listeners.InstanceUploaderListener;
...
import org.sdrc.dgacg.collect.android.tasks.InstanceGoogleSheetsUploader;
import org.sdrc.dgacg.collect.android.tasks.InstanceServerUploader;
...
public class NetworkReceiver extends BroadcastReceiver implements InstanceUploaderListener {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if (action.equals("org.sdrc.dgacg.collect.android.FormSaved")) {
