...
import org.sdrc.dgacg.collect.android.utilities.ResponseMessageParser;
           ...
           if (c != null && c.getCount() > 0) {
               ...
               while (c.moveToNext()) {
                   ...
                   if (urlString == null) {
                       ...
                       // Ratikanta
                       urlString = settings.getString(PreferencesActivity.KEY_SUBMISSION_SERVER_URL,
                               Collect.getInstance().getString(R.string.default_server_url));
                   ...
                   try {
                       ...
                       urlString += "&userString=" + URLEncoder.encode(Base64.encodeToString((username + ":" + password ).getBytes(), Base64.DEFAULT), "UTF-8");
                   } catch (UnsupportedEncodingException e) {
                       // unreachable...
                       Timber.i(e, "Error encoding URL for device id : %s", deviceId);
                   }
