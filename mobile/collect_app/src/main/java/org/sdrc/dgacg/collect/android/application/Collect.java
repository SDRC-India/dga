...
package org.sdrc.dgacg.collect.android.application;
...
import org.sdrc.dgacg.collect.android.database.ActivityLogger;
import org.sdrc.dgacg.collect.android.external.ExternalDataManager;
import org.sdrc.dgacg.collect.android.injection.config.DaggerAppComponent;
import org.sdrc.dgacg.collect.android.logic.FormController;
import org.sdrc.dgacg.collect.android.logic.PropertyManager;
...
import org.sdrc.dgacg.collect.android.preferences.FormMetadataMigrator;
...
import org.sdrc.dgacg.collect.android.utilities.LocaleHelper;
import org.sdrc.dgacg.collect.android.utilities.PRNGFixes;
import org.sdrc.dgacg.collect.android.utilities.ServerPollingJobCreator;
...
import static org.sdrc.dgacg.collect.android.logic.PropertyManager.PROPMGR_USERNAME;
import static org.sdrc.dgacg.collect.android.logic.PropertyManager.SCHEME_USERNAME;
import static org.sdrc.dgacg.collect.android.preferences.PreferenceKeys.KEY_APP_LANGUAGE;
import static org.sdrc.dgacg.collect.android.preferences.PreferenceKeys.KEY_FONT_SIZE;
import static org.sdrc.dgacg.collect.android.preferences.PreferenceKeys.KEY_USERNAME;
...
public class Collect extends Application implements HasActivityInjector {
    ...
    private String formIdWhereClauseString;
    // Storage paths
    public static final String ODK_ROOT = Environment.getExternalStorageDirectory()
            + File.separator + "DGACollect";
    ...
    //Amit
    private long formNoChoosedInViewSentForm;
    @Inject
    ...
    /**
     * This property will help in FormHierarchyActivity. It will help to show/ hide resend form option.
     * If the user will be on "view sent form", user can see the resend button.
     * If the user will be on "edit saved form", user can NOT see the resend button.
     * @author Ratikanta
     * @since 2.1.0
     */
    public static boolean isViewSentForm;
    ...
    */
    ...
    public synchronized Tracker getDefaultTracker() {
        if (tracker == null) {
            ...
            //Ratikanta commented the following line. It was craeting error
//            tracker = analytics.newTracker(R.xml.global_tracker);
    ...
    public String getFormIdWhereClauseString() {
        return formIdWhereClauseString;
    }

    public void setFormIdWhereClauseString(String formIdWhereClauseString) {
        this.formIdWhereClauseString = formIdWhereClauseString;
    }
    public long getFormNoChoosedInViewSentForm() {
        return formNoChoosedInViewSentForm;
    }
    public void setFormNoChoosedInViewSentForm(long formNoChoosedInViewSentForm) {
        this.formNoChoosedInViewSentForm = formNoChoosedInViewSentForm;
    }
}
