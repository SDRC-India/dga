...
import org.sdrc.dgacg.collect.android.listeners.DeleteFormsListener;
...
import org.sdrc.dgacg.collect.android.tasks.DeleteFormsTask;
import org.sdrc.dgacg.collect.android.tasks.DiskSyncTask;
import org.sdrc.dgacg.collect.android.utilities.ToastUtils;
import org.sdrc.dgacg.collect.android.utilities.VersionHidingCursorAdapter;
...
public class FormManagerList extends FormListFragment implements DiskSyncListener,
    ...
    public void onViewCreated(@NonNull View rootView, Bundle savedInstanceState) {
        ...
        if (backgroundTasks == null) {
            ...
            backgroundTasks.diskSyncTask = new DiskSyncTask(getActivity());
