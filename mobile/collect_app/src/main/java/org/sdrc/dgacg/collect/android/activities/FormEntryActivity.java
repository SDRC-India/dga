...
import org.sdrc.dgacg.collect.android.adapters.IconMenuListAdapter;
import org.sdrc.dgacg.collect.android.adapters.model.IconMenuItem;
import org.sdrc.dgacg.collect.android.application.Collect;
import org.sdrc.dgacg.collect.android.dao.FormsDao;
import org.sdrc.dgacg.collect.android.dao.helpers.ContentResolverHelper;
import org.sdrc.dgacg.collect.android.dao.helpers.FormsDaoHelper;
import org.sdrc.dgacg.collect.android.dao.helpers.InstancesDaoHelper;
import org.sdrc.dgacg.collect.android.exception.GDriveConnectionException;
import org.sdrc.dgacg.collect.android.exception.JavaRosaException;
import org.sdrc.dgacg.collect.android.external.ExternalDataManager;
import org.sdrc.dgacg.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.sdrc.dgacg.collect.android.fragments.dialogs.NumberPickerDialog;
import org.sdrc.dgacg.collect.android.listeners.AdvanceToNextListener;
import org.sdrc.dgacg.collect.android.listeners.FormLoaderListener;
import org.sdrc.dgacg.collect.android.listeners.FormSavedListener;
import org.sdrc.dgacg.collect.android.listeners.PermissionListener;
import org.sdrc.dgacg.collect.android.listeners.SavePointListener;
import org.sdrc.dgacg.collect.android.logic.FormController;
import org.sdrc.dgacg.collect.android.logic.FormController.FailedConstraint;
import org.sdrc.dgacg.collect.android.logic.FormInfo;
...
import org.sdrc.dgacg.collect.android.tasks.FormLoaderTask;
import org.sdrc.dgacg.collect.android.tasks.SaveFormIndexTask;
import org.sdrc.dgacg.collect.android.tasks.SavePointTask;
import org.sdrc.dgacg.collect.android.tasks.SaveResult;
import org.sdrc.dgacg.collect.android.tasks.SaveToDiskTask;
import org.sdrc.dgacg.collect.android.utilities.ActivityAvailability;
import org.sdrc.dgacg.collect.android.utilities.ApplicationConstants;
import org.sdrc.dgacg.collect.android.utilities.DependencyProvider;
import org.sdrc.dgacg.collect.android.utilities.DialogUtils;
import org.sdrc.dgacg.collect.android.utilities.FileUtils;
import org.sdrc.dgacg.collect.android.utilities.ImageConverter;
import org.sdrc.dgacg.collect.android.utilities.MediaManager;
import org.sdrc.dgacg.collect.android.utilities.MediaUtils;
import org.sdrc.dgacg.collect.android.utilities.SoftKeyboardUtils;
import org.sdrc.dgacg.collect.android.utilities.TimerLogger;
import org.sdrc.dgacg.collect.android.utilities.ToastUtils;
import org.sdrc.dgacg.collect.android.views.ODKView;
import org.sdrc.dgacg.collect.android.widgets.DateTimeWidget;
import org.sdrc.dgacg.collect.android.widgets.QuestionWidget;
import org.sdrc.dgacg.collect.android.widgets.RangeWidget;
import org.sdrc.dgacg.collect.android.widgets.StringWidget;
...
import static org.sdrc.dgacg.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.sdrc.dgacg.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.sdrc.dgacg.collect.android.utilities.PermissionUtils.checkIfStoragePermissionsGranted;
...
public class FormEntryActivity extends CollectAbstractActivity implements AnimationListener,
    ...
    private void sendSavedBroadcast() {
        sendBroadcast(new Intent("org.sdrc.dgacg.collect.android.FormSaved"));
    }
