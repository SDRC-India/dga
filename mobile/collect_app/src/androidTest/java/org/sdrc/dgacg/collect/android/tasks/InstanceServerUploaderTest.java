...
import org.sdrc.dgacg.collect.android.dto.Instance;
import org.sdrc.dgacg.collect.android.provider.InstanceProviderAPI;
import org.sdrc.dgacg.collect.android.tasks.InstanceUploader.Outcome;
import org.sdrc.dgacg.collect.android.test.MockedServerTest;

import okhttp3.mockwebserver.RecordedRequest;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertNull;
import static org.sdrc.dgacg.collect.android.test.TestUtils.assertMatches;
import static org.sdrc.dgacg.collect.android.test.TestUtils.cleanUpTempFiles;
import static org.sdrc.dgacg.collect.android.test.TestUtils.createTempFile;
import static org.sdrc.dgacg.collect.android.test.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("Dalvik/.* org.sdrc.dgacg.collect.android/.*", r.getHeader("User-Agent"));
